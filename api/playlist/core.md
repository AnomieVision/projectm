...
|                | Name           |
| -------------- | -------------- |
| PROJECTM_PLAYLIST_EXPORT [projectm_playlist_handle](/projectm/apiapi/playlist/playlist__types.md#typedef-projectm-playlist-handle) | **[projectm_playlist_create](/projectm/apiapi/playlist/playlist__core.md#function-projectm-playlist-create)**([projectm_handle](/projectm/apiapi/playlist/types.md#typedef-projectm-handle) projectm_instance)<br>Creates a playlist manager for the given projectM instance.  |
| PROJECTM_PLAYLIST_EXPORT void | **[projectm_playlist_destroy](/projectm/apiapi/playlist/playlist__core.md#function-projectm-playlist-destroy)**([projectm_playlist_handle](/projectm/apiapi/playlist/playlist__types.md#typedef-projectm-playlist-handle) instance)<br>Destroys a previously created playlist manager.  |
| PROJECTM_PLAYLIST_EXPORT void | **[projectm_playlist_connect](/projectm/apiapi/playlist/playlist__core.md#function-projectm-playlist-connect)**([projectm_playlist_handle](/projectm/apiapi/playlist/playlist__types.md#typedef-projectm-playlist-handle) instance, [projectm_handle](/projectm/apiapi/playlist/types.md#typedef-projectm-handle) projectm_instance)<br>Connects the playlist manager to a projectM instance.  |
...
To switch to another playlist, use the [projectm_playlist_connect()](/projectm/apiapi/playlist/playlist__core.md#function-projectm-playlist-connect) method.
