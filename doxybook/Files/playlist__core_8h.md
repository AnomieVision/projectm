...
|                | Name           |
| -------------- | -------------- |
| PROJECTM_PLAYLIST_EXPORT [projectm_playlist_handle](/api/Files/playlist__types_8h.md#typedef-projectm-playlist-handle) | **[projectm_playlist_create](/api/Files/playlist__core_8h.md#function-projectm-playlist-create)**([projectm_handle](/api/Files/types_8h.md#typedef-projectm-handle) projectm_instance)<br>Creates a playlist manager for the given projectM instance.  |
| PROJECTM_PLAYLIST_EXPORT void | **[projectm_playlist_destroy](/api/Files/playlist__core_8h.md#function-projectm-playlist-destroy)**([projectm_playlist_handle](/api/Files/playlist__types_8h.md#typedef-projectm-playlist-handle) instance)<br>Destroys a previously created playlist manager.  |
| PROJECTM_PLAYLIST_EXPORT void | **[projectm_playlist_connect](/api/Files/playlist__core_8h.md#function-projectm-playlist-connect)**([projectm_playlist_handle](/api/Files/playlist__types_8h.md#typedef-projectm-playlist-handle) instance, [projectm_handle](/api/Files/types_8h.md#typedef-projectm-handle) projectm_instance)<br>Connects the playlist manager to a projectM instance.  |
...
To switch to another playlist, use the [projectm_playlist_connect()](/api/Files/playlist__core_8h.md#function-projectm-playlist-connect) method.
