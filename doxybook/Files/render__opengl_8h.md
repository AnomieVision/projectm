...
|                | Name           |
| -------------- | -------------- |
| PROJECTM_EXPORT void | **[projectm_opengl_render_frame](/api/Files/render__opengl_8h.md#function-projectm-opengl-render-frame)**([projectm_handle](/api/Files/types_8h.md#typedef-projectm-handle) instance)<br>Renders a single frame.  |
